...
The section *Infections Proportion Statistics by Variant* calculates a few variant proportions, and stores the results in named-list variable \textcolor[rgb]{0.5, 0.5, 0.0}{\emph{proportions}}.
...
The \textcolor[rgb]{0.5, 0.5, 0.0}{\emph{proportions}} data frame element *leading* lists the five variants responsible for the five largest variant-infection--proportions, w.r.t. **(a)** known & unknown travel links, and **(b)** the data's time span; *Table 3*.
...
```{r out.width = '57%', fig.align = 'center', fig.cap = "Weekly fraction proportions of the predominant variants listed in Table 3; w.r.t. (a) travel and non-travel infections, and (b) the data's time span.  For a better view of the curves with generally small fractions, refer to Fig. 3; it is a version of this graph with a re-scaled y-axis. "}
PredominantVariants(predominant = proportions$leadingseries)

```

```{r out.width = '57%', fig.align = 'center', fig.cap = "A version of Fig. 2 wherein the y-axis has been re-scaled, this makes it easier to observe the progression of curves that have generally small fraction values."}
