...
```{r out.width = '45%', fig.align = 'center', fig.cap = 'The non-travel VUI.21OCT.01 variant infection fractions over time.'}
...
```{r out.width = '45%', fig.align = 'center', fig.cap = 'The original non-travel VUI.21OCT.01 variant infection fractions over time, and predictions.  During January 2022 the predictions become implausible; a prediction should not exceed 1 because it is a fraction, and it can only equal 1 if, and only if, no other variant exists.'}
